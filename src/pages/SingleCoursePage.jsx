...
const SingleCoursePage = () => {
  const {id} = useParams();
  const {fetchingSingleCourse, single_course} = useCoursesContext();
  const {addToCart} = useCartContext();

  useEffect(()=>{
    fetchingSingleCourse(id)
  }, [])

  const {id:courseID, category, image, course_name, description, rating_count,
  rating_star, students, creator, updated_date, lang, actual_price, 
  discounted_price, what_you_will_learn:learnItems, content} = single_course;

  return (
    <SingleCourseWrapper>
      <div className="course-intro mx-auto sgrid">
        ...
        <div className="course-details">
          ...
          <div className="course-body">
            ...
            <div className="course-rating flex">
              ...
              <span className="student-count fs-14">{students}</span>
            </div>
          ...
          <div className="course-foot">
            <div className="course-price">
              ...
              <span className="old-price fs-26 fw-8">
                R{actual_price}
              </span>
            </div>
          </div>
      ...
      <div className="course-full bg-white text-dark">
        <div className="course-learn mx-auto">
          ...
          <ul className="course-learn-list grid">
            {
              learnItems && learnItems.map((learnItem, index) =>{
                return(
                  <li key={index}>
                    <span><BiCheck/></span>
